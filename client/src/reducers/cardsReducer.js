...
const card1 = new Card(1, 'Description of the card with id equals to 1. Awesome!', new Date(), 1, false, 'Card#1');
const card2 = new Card(2, 'This is a very useful description for card with id 2.', new Date(), 2, false, 'Card#2');
const card3 = new Card(3, 'This is a very useful description for card with id 3.', new Date(), 3, false, 'Card#3');
const card4 = new Card(4, 'This is a very useful description for card with id 4.', new Date(), 4, false, 'Card#4');
const card5 = new Card(5, 'This is a very useful description for card with id 5.', new Date(), 5, true, 'Card#5');
